...
<div class="auth_tab">
    <div class="auth_tab_links">
        <ul>
            <li id="accountLogin" style="width:100%;" class="selected" tabid="01"><span>管理员登录</span></li>
        </ul>
    </div>
        ...
        <div tabid="01" class="auth_tab_content_item">
            <form id="casLoginForm" class="fm-v clearfix amp-login-form" role="form" action=" " method="post">
                <p>
                    ...
                    <input id="username" name="username" placeholder="账号" class="auth_input" type="text" value=""/>
    ...
    <section id="footer-menu">
        <div class="container">
            <p align="center">
                ...
                <%--<a class="my_a_link" href="404.jsp" style="color: #1a1a1a">登陆</a>--%>
            </p>
        </div>
    </section>
</div>
