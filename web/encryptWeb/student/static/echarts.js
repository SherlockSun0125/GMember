    ...
    (function (e) {
        ...
        (function (e) {
            ...
            var e = {
                ...
                toolbox: {
                    ...
                    feature: {
                        ...
                        dataView: {show: !1, title: "鏁版嵁瑙嗗浘", readOnly: !1, lang: ["Data View", "close", "refresh"]},
                        magicType: {
                            show: !1,
                            title: {line: "鎶樼嚎鍥惧垏鎹�", bar: "鏌卞舰鍥惧垏鎹�", stack: "鍫嗗彔", tiled: "骞抽摵"},
                            type: []
                        },
                ...
                markLine: {
                    ...
                    itemStyle: {
                        normal: {
                            borderWidth: 2,
                            label: {show: !1, position: "inside", textStyle: {color: "#333"}},
                            lineStyle: {
                                type: "solid",
                                shadowColor: "rgba(0,0,0,0)",
                                shadowBlur: 5,
            ...
            return document.createElement("canvas").getContext ? G_vmlCanvasManager = !1 : function () {
                ...
                function I(e) {
                    this.m_ = E(), this.mStack_ = [], this.aStack_ = [], this.currentPath_ = [], this.strokeStyle = "#000", this.fillStyle = "#000", this.lineWidth = 1, this.lineJoin = "miter", this.lineCap = "butt", this.miterLimit = o * 1, this.globalAlpha = 1, this.font = "12px 寰蒋闆呴粦", this.textAlign = "left", this.textBaseline = "alphabetic", this.canvas = e;
                ...
                function z(t, n, r, i) {
                    ...
                    if (s instanceof $) {
                        ...
                        if (s.type_ == "gradient") {
                            var v = s.x0_ / u, m = s.y0_ / a, g = s.x1_ / u, y = s.y1_ / a, b = W(t, v, m),
                                w = W(t, g, y), E = w.x - b.x, S = w.y - b.y;
                ...
                var T = {
                        ...
                        whitesmoke: "#F5F5F5",
                        yellowgreen: "#9ACD32"
                    }, O = {}, _ = {style: "normal", variant: "normal", weight: "normal", size: 12, family: "寰蒋闆呴粦"},
                ...
                q.clearRect = function () {
                    ...
                    var u = this.m_, a = 1e3, f = 0, l = a, c = {x: 0, y: 0}, p = [],
                        d = H(P(this.font), this.element_), v = B(d), m = this.element_.currentStyle,
        ...
        }), r("zrender/tool/area", ["require", "../tool/util", "../shape"], function (e) {
            function r(e, r, u, a) {
                if (!r || !e) return !1;
                var f = e.type;
                n || (n = t.getContext());
            ...
            function y(e, r) {
                n || (n = t.getContext()), n.save(), r && (n.font = r), e = (e + "").split("\n");
                var i = (n.measureText("鍥�").width + 2) * e.length;
                return n.restore(), i
            }
            ...
            function X(e) {
                var t = e[0] / 255, n = e[1] / 255, r = e[2] / 255, i = Math.min(t, n, r), s = Math.max(t, n, r),
                    o = s - i, u = s, a, f;
                if (o === 0) a = 0, f = 0; else {
                    f = o / s;
            ...
            n.prototype = {
                brush: function (e, n, r) {
                    ...
                    var s = (i.text + "").split("\n"), o = t.getTextHeight("鍥�", i.textFont), u = this.getRect(i),
                        a = i.x, f;
            ...
            t.prototype = {
                _parsePathData: function (e) {
                    ...
                    var n = t.path, r = this._parsePathData(n), i = t.x || 0, s = t.y || 0, o, u = t.pointList = [],
                        a = [];
            ...
            function f(e) {
                return {
                    shape: "rectangle",
                    highlightStyle: {x: 0, y: 0, width: s, height: o, brushType: "fill", color: e}
                }
            }
            ...
            function p(n, r, i) {
                ...
                var l = a(n.textStyle), c = f(n.backgroundColor), h = n.effectOption, p = h.n, d = h.lineWidth, v = [],
                    m, g, y, b;
            ...
            function v(n, r, i) {
                ...
                var c = a(n.textStyle), h = f(n.backgroundColor), p = l.n, d = l.x, v = l.y, m = l.r0, g = l.r,
                    y = l.color, b = [], w = Math.round(180 / p);
            ...
            function m(n, r, i) {
                ...
                var d = a(n.textStyle), v = f(n.backgroundColor), m = h.x, g = h.y, y = h.r0 + 6, b = h.r - 6,
                    w = h.color, E = u.lift(w, .1), S = {shape: "ring", highlightStyle: t.clone(h)}, x = [],
            ...
            function o(n, i, s) {
                ...
                var p = new u(c), d = new a(i, p, c), v = new f(i, p, d, c), m = e("./animation/animation"), g = [],
                    y = new m({
                        stage: {
                            update: function () {
                                var e = g;
            ...
            function a(n, i, s) {
                function b() {
                    ...
                    return n.clientWidth - e.paddingLeft.replace(/\D/g, "") - e.paddingRight.replace(/\D/g, "")
                }

                function w() {
                    var e = n.currentStyle || document.defaultView.getComputedStyle(n);
                    return n.clientHeight - e.paddingTop.replace(/\D/g, "") - e.paddingBottom.replace(/\D/g, "")
                }
            ...
            function f(t, n, r, i) {
                ...
                var a = this, f = u.getX, l = u.getY, c, h = !1, p = null, d = null, v = null, m = !1, g = !1, y, b, w,
                    E = 0, S = 0, x = 0, T = 0, N = r.getDomHover();
                a.on = K, a.un = Q, a.trigger = G, a.dispose = Y, C()
            }

            e("./lib/excanvas");
            var t = e("./tool/util"), n = {}, r = n, i = 0, s = {};
            return n.version = "1.1.0", n.init = function (e, t) {
                var n = new o(++i + "", e, t || {});
                return s[i] = n, n
            ...
            return e
        }), r("echarts/util/shape/icon", ["require", "zrender/tool/matrix", "zrender/shape", "zrender/shape", "zrender/shape", "zrender/shape", "zrender/shape/base", "zrender/shape"], function (e) {
            function n() {
            ...
            return n.prototype = {
                buildPath: function (e, t) {
                    ...
                    var u = o.height < 10 || o.width < 10 ? 4 : 0;
        ...
        }), r("echarts/util/shape/markLine", ["require", "zrender/tool/matrix", "zrender/shape", "zrender/shape", "zrender/shape/base", "zrender/shape"], function (e) {
            function n() {
                this.type = "markLine"
            }
            ...
            return n.prototype = {
                brush: function (e, t, n) {
                    ...
                    r.save(), r.beginPath(), r.lineWidth = i.symbolBorder, r.strokeStyle = i.symbolBorderColor, i.iconType = i.symbol[s].replace("empty", "").toLowerCase(), i.symbol[s].match("empty") && (r.fillStyle = "rgba(0, 0, 0, 0)");
                    ...
                    r.closePath(), r.stroke(), r.fill(), r.restore()
                }, buildArrawPath: function (e, t, n) {
                    var r = Math.round(t.pointListLength || t.pointList.length), i = t.symbolSize[n] * 2,
                        s = t.pointList[0][0], o = t.pointList[r - 1][0], u = t.pointList[0][1],
        ...
        }), r("echarts/component/base", ["require", "../util/ecData", "zrender/tool/util", "zrender/shape"], function (e) {
            function t(t, n) {
                function f(e) {
                    e = e || s.type + "";
                    switch (e) {
                ...
                function l(e) {
                    return i.merge(e || {}, i.clone(t[s.type] || {}), {overwrite: !1, recursive: !0})
                }
                ...
                function d(e, t) {
                    var n, r, s = e.length;
                    while (s--) r = h(e[s], t), typeof r != "undefined" && (typeof n == "undefined" ? n = i.clone(r) : i.merge(n, r, {
                        overwrite: !0,
                        recursive: !0
                    }));
                    return n
                ...
                function v(e) {
                    var n = i.merge(i.clone(e) || {}, t.textStyle, {overwrite: !1});
                    return n.fontStyle + " " + n.fontWeight + " " + n.fontSize + "px " + n.fontFamily
                }

                function m(e, t, n, r, i) {
                    var o = [n, t], u = d(o, "itemStyle.normal.label"), a = d(o, "itemStyle.emphasis.label"),
                        f = u.textStyle || {}, l = a.textStyle || {};
                    return u.show && (e.style.text = g(t, n, r, "normal"), e.style.textPosition = typeof u.position == "undefined" ? i == "horizontal" ? "right" : "top" : u.position, e.style.textColor = f.color, e.style.textFont = s.getFont(f)), a.show && (e.highlightStyle.text = g(t, n, r, "emphasis"), e.highlightStyle.textPosition = u.show ? e.style.textPosition : typeof a.position == "undefined" ? i == "horizontal" ? "right" : "top" : a.position, e.highlightStyle.textColor = l.color, e.highlightStyle.textFont = s.getFont(l)), e
                }

                function g(e, t, n, r) {
                    var i = s.deepQuery([t, e], "itemStyle." + r + ".label.formatter");
                    !i && r == "emphasis" && (i = s.deepQuery([t, e], "itemStyle.normal.label.formatter"));
                    var o = typeof t != "undefined" ? typeof t.value != "undefined" ? t.value : t : "-";
                    if (!i) return o;
                    if (typeof i == "function") return i(e.name, n, o);
                    if (typeof i == "string") return i = i.replace("{a}", "{a0}").replace("{b}", "{b0}").replace("{c}", "{c0}"), i = i.replace("{a0}", e.name).replace("{b0}", n).replace("{c0}", o), i
                }

                function y(e, t, n, r, i) {
                    s.selectedMap[e.name] && (e.markPoint && b(e, t, n, r, i), e.markLine && w(e, t, n, r, i))
                }

                function b(e, n, r, o, u) {
                    var a = s.getZlevelBase(), f, l, c = i.clone(e.markPoint);
                    for (var h = 0, p = c.data.length; h < p; h++) f = c.data[h], l = s.getMarkCoord(e, n, f, o), c.data[h].x = typeof f.x != "undefined" ? f.x : l[0], c.data[h].y = typeof f.y != "undefined" ? f.y : l[1];
                    var d = E(e, n, c, r);
                    for (var h = 0, p = d.length; h < p; h++) {
                        d[h].zlevel = a + 1;
                        for (var v in u) d[h][v] = u[v];
                        s.shapeList.push(d[h])
                    }
                    if (s.type == t.CHART_TYPE_FORCE || s.type == t.CHART_TYPE_CHORD) for (var h = 0, p = d.length; h < p; h++) d[h].id = s.zr.newShapeId(s.type), s.zr.addShape(d[h])
                }

                function w(e, n, r, o, u) {
                    var a = s.getZlevelBase(), f, l, c = i.clone(e.markLine);
                    for (var h = 0, p = c.data.length; h < p; h++) f = c.data[h], l = [s.getMarkCoord(e, n, f[0], o), s.getMarkCoord(e, n, f[1], o)], c.data[h][0].x = typeof f[0].x != "undefined" ? f[0].x : l[0][0], c.data[h][0].y = typeof f[0].y != "undefined" ? f[0].y : l[0][1], c.data[h][1].x = typeof f[1].x != "undefined" ? f[1].x : l[1][0], c.data[h][1].y = typeof f[1].y != "undefined" ? f[1].y : l[1][1];
                    var d = S(e, n, c, r);
                    for (var h = 0, p = d.length; h < p; h++) {
                        d[h].zlevel = a + 1;
                        for (var v in u) d[h][v] = u[v];
                ...
                function E(e, n, o, u) {
                    i.merge(o, t.markPoint, {overwrite: !1, recursive: !0}), o.name = e.name;
                    var a = [], f = o.data, l, c = u.dataRange, h = u.legend, p, d, v, m, g, y, b = s.zr.getWidth(),
                        w = s.zr.getHeight();
                    for (var E = 0, S = f.length; E < S; E++) {
                        h && (p = h.getColor(e.name));
                        if (c) {
                            d = typeof f[E] != "undefined" ? typeof f[E].value != "undefined" ? f[E].value : f[E] : "-", p = isNaN(d) ? p : c.getColor(d), v = [f[E], o], m = s.deepQuery(v, "itemStyle.normal.color") || p, g = s.deepQuery(v, "itemStyle.emphasis.color") || m;
                            if (m == null && g == null) continue
                        }
                        f[E].tooltip = {trigger: "item"}, f[E].name = typeof f[E].name != "undefined" ? f[E].name : "", f[E].value = typeof f[E].value != "undefined" ? f[E].value : "", l = T(o, n, f[E], E, f[E].name, C(f[E].x, b), C(f[E].y, w), "pin", p, "rgba(0,0,0,0)", "horizontal"), y = s.deepMerge([f[E], o], "effect"), y.show && (l.effect = y), r.pack(l, e, n, f[E], 0, f[E].name), a.push(l)
                    }
                    return a
                }

                function S(e, n, o, u) {
                    i.merge(o, t.markLine, {
                        overwrite: !1,
                        recursive: !0
                    }), o.symbol = o.symbol instanceof Array ? o.symbol.length > 1 ? o.symbol : [o.symbol[0], o.symbol[0]] : [o.symbol, o.symbol], o.symbolSize = o.symbolSize instanceof Array ? o.symbolSize.length > 1 ? o.symbolSize : [o.symbolSize[0], o.symbolSize[0]] : [o.symbolSize, o.symbolSize], o.symbolRotate = o.symbolRotate instanceof Array ? o.symbolRotate.length > 1 ? o.symbolRotate : [o.symbolRotate[0], o.symbolRotate[0]] : [o.symbolRotate, o.symbolRotate], o.name = e.name;
                    var a = [], f = o.data, l, c = u.dataRange, h = u.legend, p, d, v, m, g, y, b = s.zr.getWidth(),
                        w = s.zr.getHeight(), E;
                    for (var S = 0, x = f.length; S < x; S++) {
                        h && (p = h.getColor(e.name)), E = s.deepMerge(f[S]);
                        if (c) {
                            d = typeof E != "undefined" ? typeof E.value != "undefined" ? E.value : E : "-", p = isNaN(d) ? p : c.getColor(d), v = [E, o], m = s.deepQuery(v, "itemStyle.normal.color") || p, g = s.deepQuery(v, "itemStyle.emphasis.color") || m;
                            if (m == null && g == null) continue
                        }
                        f[S][0].tooltip = E.tooltip || {trigger: "item"}, f[S][0].name = typeof f[S][0].name != "undefined" ? f[S][0].name : "", f[S][1].name = typeof f[S][1].name != "undefined" ? f[S][1].name : "", f[S][0].value = typeof f[S][0].value != "undefined" ? f[S][0].value : "", l = N(o, n, f[S], S, C(f[S][0].x, b), C(f[S][0].y, w), C(f[S][1].x, b), C(f[S][1].y, w), p), y = s.deepMerge([E, o], "effect"), y.show && (l.effect = y), r.pack(l, e, n, f[S][0], 0, f[S][0].name + " : " + f[S][1].name), a.push(l)
                    }
                    return a
                }
                ...
                function T(e, t, n, i, o, u, a, f, l, c, h) {
                    var p = [n, e], d = typeof n != "undefined" ? typeof n.value != "undefined" ? n.value : n : "-";
                    f = s.deepQuery(p, "symbol") || f;
                    var v = s.deepQuery(p, "symbolSize");
                    v = typeof v == "function" ? v(d) : v;
                    var m = s.deepQuery(p, "symbolRotate"), g = s.deepMerge(p, "itemStyle.normal"),
                        y = s.deepMerge(p, "itemStyle.emphasis"),
                    ...
                    var E = {
                        ...
                        style: {
                            ...
                            height: v * 2,
                            brushType: "both",
                            color: f.match("empty") ? c : s.getItemStyleColor(g.color, t, i, n) || l,
                            strokeColor: g.borderColor || s.getItemStyleColor(g.color, t, i, n) || l,
                            lineWidth: b
                        },
                        highlightStyle: {
                            color: f.match("empty") ? c : s.getItemStyleColor(y.color, t, i, n),
                            strokeColor: y.borderColor || g.borderColor || s.getItemStyleColor(g.color, t, i, n) || l,
                            lineWidth: w
                        },
                        clickable: !0
                    };
                    return f.match("image") && (E.style.image = f.replace(new RegExp("^image:\\/\\/"), ""), E.shape = "image"), typeof m != "undefined" && (E.rotation = [m * Math.PI / 180, u, a]), f.match("star") && (E.style.iconType = "star", E.style.n = f.replace("empty", "").replace("star", "") - 0 || 5), f == "none" && (E.invisible = !0, E.hoverable = !1), E = s.addLabel(E, e, n, o, h), f.match("empty") && (typeof E.style.textColor == "undefined" && (E.style.textColor = E.style.strokeColor), typeof E.highlightStyle.textColor == "undefined" && (E.highlightStyle.textColor = E.highlightStyle.strokeColor)), r.pack(E, e, t, n, i, o), E._mark = "point", E._x = u, E._y = a, E._dataIndex = i, E._seriesIndex = t, E
                }

                function N(e, t, n, r, i, o, u, a, f) {
                    var l = typeof n[0] != "undefined" ? typeof n[0].value != "undefined" ? n[0].value : n[0] : "-",
                        ...
                        h = [s.query(n[0], "symbol") || e.symbol[0], s.query(n[1], "symbol") || e.symbol[1]],
                        p = [s.query(n[0], "symbolSize") || e.symbolSize[0], s.query(n[1], "symbolSize") || e.symbolSize[1]];
                    p[0] = typeof p[0] == "function" ? p[0](l) : p[0], p[1] = typeof p[1] == "function" ? p[1](c) : p[1];
                    var d = [s.query(n[0], "symbolRotate") || e.symbolRotate[0], s.query(n[1], "symbolRotate") || e.symbolRotate[1]],
                        v = [n[0], e], m = s.deepMerge(v, "itemStyle.normal");
                    m.color = s.getItemStyleColor(m.color, t, r, n);
                    var g = s.deepMerge(v, "itemStyle.emphasis");
                    g.color = s.getItemStyleColor(g.color, t, r, n);
                    ...
                    return S = s.addLabel(S, e, n[0], n[0].name + " : " + n[1].name), S._mark = "line", S._x = u, S._y = a, S
                }

                function C(e, t) {
                    return typeof e == "string" ? M(e).match(/%$/) ? parseFloat(e) / 100 * t : parseFloat(e) : e
                }

                function k(e) {
                    return [C(e[0], s.zr.getWidth()), C(e[1], s.zr.getHeight())]
                }

                function L(e) {
                    e instanceof Array || (e = [0, e]);
                    var t = Math.min(s.zr.getWidth(), s.zr.getHeight()) / 2;
                ...
                function D() {
                    a[s.type] ? s.animationMark(t.animationDuration) : s.animationEffect()
                }

                function P(t, r) {
                    var i = e("zrender/shape").get("markLine"), o, u;
                    for (var a = 0, f = s.shapeList.length; a < f; a++) {
                        if (!s.shapeList[a]._mark) continue;
                        o = s.shapeList[a]._x || 0, u = s.shapeList[a]._y || 0, s.shapeList[a]._mark == "point" ? (n.modShape(s.shapeList[a].id, {scale: [0, 0, o, u]}, !0), n.animate(s.shapeList[a].id, "").when(t, {scale: [1, 1, o, u]}).start(r || "QuinticOut")) : s.shapeList[a]._mark == "line" && (s.shapeList[a].style.smooth ? (n.modShape(s.shapeList[a].id, {style: {pointListLength: 1}}, !0), n.animate(s.shapeList[a].id, "style").when(t, {pointListLength: s.shapeList[a].style.pointList.length}).start(r || "QuinticOut")) : (n.modShape(s.shapeList[a].id, {style: {pointList: [[s.shapeList[a].style.xStart, s.shapeList[a].style.yStart], [s.shapeList[a].style.xStart, s.shapeList[a].style.yStart]]}}, !0), n.animate(s.shapeList[a].id, "style").when(t, {pointList: [[s.shapeList[a].style.xStart, s.shapeList[a].style.yStart], [o, u]]}).start(r || "QuinticOut")))
                    }
                    s.animationEffect()
                }
                ...
                function H() {
                    j();
                    var e = o;
                    u && n.modLayer(e, {motionBlur: !0, lastFrameAlpha: .95});
                    var t, r, i, a;
                    for (var f = 0, l = s.shapeList.length; f < l; f++) {
                        shape = s.shapeList[f];
                        if (!shape._mark || !shape.effect || !shape.effect.show) continue;
                        a = shape.effect, t = a.color || shape.style.strokeColor || shape.style.color, r = a.shadowColor || t;
                        var c, h;
                        switch (shape._mark) {
                            case"point":
                                i = a.scaleSize, shadowBlur = typeof a.shadowBlur != "undefined" ? a.shadowBlur : i, c = {
                                    shape: shape.shape,
                                    id: n.newShapeId(),
                                    zlevel: e,
                                    style: {
                                    ...
                                    draggable: !1,
                                    hoverable: !1
                                }, u && (c.style.image = n.shapeToImage(c, c.style.width + shadowBlur * 2 + 2, c.style.height + shadowBlur * 2 + 2).style.image, c.shape = "image"), h = (c.style.width - shape.style.width) / 2;
                                break;
                            case"line":
                                i = shape.style.lineWidth * a.scaleSize, shadowBlur = typeof a.shadowBlur != "undefined" ? a.shadowBlur : i, c = {
                                    shape: "circle",
                                    id: n.newShapeId(),
                                    zlevel: e,
                                    style: {
                                    ...
                                    draggable: !1,
                                    hoverable: !1
                                }, u ? (c.style.image = n.shapeToImage(c, (i + shadowBlur) * 2, (i + shadowBlur) * 2).style.image, c.shape = "image", h = shadowBlur) : h = 0
                        }
                        var p;
                        c.position = shape.position;
                        if (shape._mark === "point") c.style.x = shape.style.x - h, c.style.y = shape.style.y - h, p = (a.period + Math.random() * 10) * 100; else if (shape._mark === "line") {
                            ...
                            p = Math.round(Math.sqrt(Math.round(d * a.period * a.period)))
                        }
                        s.effectList.push(c), n.addShape(c);
                ...
                function j() {
                    s.zr && s.effectList.length > 0 && (s.zr.modLayer(o, {motionBlur: !1}), s.zr.delShape(s.effectList)), s.effectList = []
                }

                function F() {
                    j(), s.zr && s.zr.delShape(s.shapeList), s.shapeList = []
                }

                function I() {
                    s.clear(), s.shapeList = null, s.effectList = null, s = null
                }

                var r = e("../util/ecData"), i = e("zrender/tool/util"), s = this;
                s.zr = n, s.shapeList = [], s.effectList = [];
                var o = 7, u = !G_vmlCanvasManager, a = {};
                a[t.CHART_TYPE_LINE] = !0, a[t.CHART_TYPE_BAR] = !0, a[t.CHART_TYPE_SCATTER] = !0, a[t.CHART_TYPE_PIE] = !0, a[t.CHART_TYPE_RADAR] = !0, a[t.CHART_TYPE_MAP] = !0, a[t.CHART_TYPE_K] = !0, a[t.CHART_TYPE_CHORD] = !0, s.getZlevelBase = f, s.reformOption = l, s.reformCssArray = c, s.query = h, s.deepQuery = p, s.deepMerge = d, s.getFont = v, s.addLabel = m, s.buildMark = y, s.getMarkCoord = x, s.getSymbolShape = T, s.parsePercent = C, s.parseCenter = k, s.parseRadius = L, s.numAddCommas = A, s.getItemStyleColor = O, s.subPixelOptimize = _, s.animation = D, s.animationMark = P, s.animationEffect = H, s.resize = B, s.clearAnimationShape = j, s.clear = F, s.dispose = I
            }
            ...
            return t
        }), r("echarts/chart/island", ["require", "../component/base", "./calculableBase", "../util/ecData", "zrender/tool/event", "zrender/tool/color", "../util/accMath", "../chart"], function (e) {
            function t(t, n, r) {
                function v(t, n) {
        ...
        }), r("echarts/component/title", ["require", "./base", "zrender/tool/area", "zrender/tool/util", "../component"], function (e) {
            function t(t, n, r, i) {
                function h() {
                    c = v(), d(), p();
                ...
                function v() {
                    var e = f.text, t = f.subtext, n = a.getFont(f.textStyle), i = a.getFont(f.subtextStyle),
                        ...
                        u = o.getTextHeight(e, n) + (t === "" ? 0 : f.itemGap + o.getTextHeight(t, i)), l,
                        c = r.getWidth();
                    switch (f.x) {
                        case"center":
                            l = Math.floor((c - s) / 2);
        ...
        }), r("echarts/component/categoryAxis", ["require", "./base", "zrender/tool/util", "zrender/tool/area", "../component"], function (e) {
            function t(t, n, r, i, s) {
                ...
                function y() {
                    var e, t = i.data.length, n = i.axisTick, r = n.length, s = n.lineStyle.color,
                        o = n.lineStyle.width, u = n.interval == "auto" ? h : n.interval - 0 + 1, a = n.onGap,
        ...
        }), r("echarts/component/valueAxis", ["require", "./base", "zrender/tool/util", "../component"], function (e) {
            function t(t, n, r, i, s, o) {
                ...
                function b() {
                    var e, t = v, n = v.length, r = i.axisTick, s = r.length, o = r.lineStyle.color,
                        u = r.lineStyle.width;
                    if (i.position == "bottom" || i.position == "top") {
                        var a = i.position == "bottom" ? r.inside ? l.getYend() - s : l.getYend() : r.inside ? l.getY() : l.getY() - s,
                            h;
                        for (var p = 0; p < n; p++) h = f.subPixelOptimize(A(t[p]), u), e = {
                            shape: "line",
                            zlevel: c,
                            hoverable: !1,
                        ...
                        var d = i.position == "left" ? r.inside ? l.getX() : l.getX() - s : r.inside ? l.getXend() - s : l.getXend(),
                            m;
                        for (var p = 0; p < n; p++) m = f.subPixelOptimize(A(t[p]), u), e = {
                            shape: "line",
                            zlevel: c,
                            hoverable: !1,
                ...
                function w() {
                    var e, t = v, n = v.length, r = i.axisLabel.rotate, s = i.axisLabel.margin,
                ...
                function E() {
                    ...
                    if (i.position == "bottom" || i.position == "top") {
                        ...
                        for (var m = 1; m < n - 1; m++) d = f.subPixelOptimize(A(t[m]), o), e = {
                            shape: "line",
                            zlevel: c,
                            hoverable: !1,
                            style: {
                        ...
                        for (var m = 1; m < n - 1; m++) b = f.subPixelOptimize(A(t[m]), o), e = {
                            shape: "line",
                            zlevel: c,
                            hoverable: !1,
                            style: {
                ...
                function S() {
                    ...
                    if (t instanceof Array) {
                        ...
                        if (i.position == "bottom" || i.position == "top") {
                            ...
                            for (var p = 0; p <= s; p++) h = p < s ? A(r[p]) : l.getXend(), e = {
                                shape: "rectangle",
                                zlevel: c,
                                hoverable: !1,
                            ...
                            for (var p = 0; p <= s; p++) y = p < s ? A(r[p]) : l.getY(), e = {
                                shape: "rectangle",
                                zlevel: c,
                                hoverable: !1,
                ...
                function x() {
                    if (isNaN(i.min) || isNaN(i.max)) {
                        ...
                        for (var l = 0, c = o.length; l < c; l++) {
                            ...
                            if (!o[l].stack) {
                                ...
                                n[y] = n[y] || [], n[b] = n[b] || [], e = o[l].data;
                                for (var m = 0, g = e.length; m < g; m++) {
                                    r = typeof e[m].value != "undefined" ? e[m].value : e[m];
                                    if (r == "-") continue;
                                    r -= 0, r >= 0 ? typeof n[y][m] != "undefined" ? n[y][m] += r : n[y][m] = r : typeof n[b][m] != "undefined" ? n[b][m] += r : n[b][m] = r
                                }
                            }
                        }
                        for (var l in n) {
                    ...
                    h = isNaN(i.min) ? h - Math.abs(h * i.boundaryGap[0]) : i.min, p = isNaN(i.max) ? p + Math.abs(p * i.boundaryGap[1]) : i.max, h == p && (p === 0 ? p = i.power > 0 ? i.power : 1 : p > 0 ? h = p / i.splitNumber : p /= i.splitNumber), T(i.scale)
                }

                function T(e) {
                    var t = i.splitNumber, n = i.precision, r, s;
                    n === 0 ? s = i.power : (s = Math.pow(10, n), h *= s, p *= s, s = i.power);
                    var o;
                    if (h >= 0 && p >= 0) {
                        e || (h = 0);
                        while (p / s < t && s != 1) s /= 10;
                        o = p - h, r = Math.ceil(o / t / s) * s, e && (n === 0 && (h = Math.floor(h / r) * r), h + r * t < p && (r = Math.ceil((p - h) / t / s) * s)), p = h + r * t
                    } else if (h <= 0 && p <= 0) {
                        e || (p = 0), s = -s;
                        while (h / s < t && s != -1) s /= 10;
                        o = h - p, r = -Math.ceil(o / t / s) * s, e && (n === 0 && (p = Math.ceil(p / r) * r), p - r * t > h && (r = Math.ceil((h - p) / t / s) * s)), h = -r * t + p
                    } else {
                        o = p - h;
                ...
                f.init = k, f.refresh = L, f.getExtremum = C, f.getCoord = A, f.getPosition = O, k(i, l, o)
            }

            return e("../component").define("valueAxis", t), t
        }), r("echarts/component/axis", ["require", "./base", "./categoryAxis", "./valueAxis", "../component"], function (e) {
            function t(t, n, r, i, s, o) {
                function l(e) {
        ...
        }), r("echarts/component/grid", ["require", "./base", "../component"], function (e) {
            function t(t, n, r, i) {
                function d(e) {
        ...
        }), r("echarts/component/dataZoom", ["require", "./base", "../component", "zrender/tool/util", "zrender/tool/util", "zrender/tool/util", "../component"], function (e) {
            function t(t, n, r, i, s) {
                function S() {
                    k(), L(), A(), O();
                ...
                function C(n) {
                    ...
                    var f = new u(t, null, !1, {xAxis: a, series: i.series}, s, "xAxis"),
                ...
                function k() {
                    ...
                    var b = [], w = h.width / e, S = h.height / e;
                ...
                function V(e) {
                    ...
                    if (i.dataZoom.show || u.query(i, "toolbox.show") && u.query(i, "toolbox.feature.dataZoom")) h = x(), p = T(), N();
                    i.dataZoom.show && (S(), B())
                }

                function $() {
                    u.clear();
                    if (i.dataZoom.show || u.query(i, "toolbox.show") && u.query(i, "toolbox.feature.dataZoom")) h = x(), p = T();
                    i.dataZoom.show && S()
                }
        ...
        }), r("echarts/component/legend", ["require", "./base", "zrender/tool/util", "zrender/tool/area", "zrender/tool/color", "zrender/shape", "zrender/shape", "zrender/shape", "zrender/shape", "zrender/shape", "../component"], function (e) {
            function t(t, r, i, s, o) {
                ...
                function E() {
                    var e = h.data, t = e.length, n, r, s, o, u = h.textStyle, l = c.getFont(u), v, m, y = i.getWidth(),
                        b = i.getHeight(), w = d.x, E = d.y, x = h.itemWidth, T = h.itemHeight, L = h.itemGap, A;
                    h.orient == "vertical" && h.x == "right" && (w = d.x + d.width - x);
                    for (var O = 0; O < t; O++) {
                        v = a.merge(e[O].textStyle || {}, u, {overwrite: !1}), m = c.getFont(v), n = e[O].name || e[O];
                        if (n === "") {
                            h.orient == "horizontal" ? (w = d.x, E += T + L) : (h.x == "right" ? w -= d.maxWidth + L : w += d.maxWidth + L, E = d.y);
                            continue
                        }
                        r = N(n).type, A = M(n), h.orient == "horizontal" ? y - w < 200 && x + 5 + f.getTextWidth(n, m) + (O == t - 1 || e[O + 1] === "" ? 0 : L) >= y - w && (w = d.x, E += T + L) : b - E < 200 && T + (O == t - 1 || e[O + 1] === "" ? 0 : L) >= b - E && (h.x == "right" ? w -= d.maxWidth + L : w += d.maxWidth + L, E = d.y), s = C(w, E, x, T, g[n] ? A : "#ccc", r, A), s._name = n, h.selectedMode && (s.onclick = k), c.shapeList.push(s), o = {
                            shape: "text",
                            zlevel: p,
                            style: {
                                x: w + x + 5,
                                y: E,
                                color: g[n] ? v.color === "auto" ? A : v.color : "#ccc",
                                text: n,
                                textFont: m,
                                textBaseline: "top"
                            },
                            highlightStyle: {color: A, brushType: "fill"},
                            hoverable: !!h.selectedMode,
                            clickable: !!h.selectedMode
                        }, h.orient == "vertical" && h.x == "right" && (o.style.x -= x + 10, o.style.textAlign = "right"), o._name = n, h.selectedMode && (o.onclick = k), c.shapeList.push(o), h.orient == "horizontal" ? w += x + 5 + f.getTextWidth(n, m) + L : E += T + L
                    }
                    h.orient == "horizontal" && h.x == "center" && E != d.y && S()
                }
                ...
                function N(e) {
                    ...
                    for (var o = 0, u = n.length; o < u; o++) {
                        ...
                        if (n[o].type == t.CHART_TYPE_PIE || n[o].type == t.CHART_TYPE_RADAR || n[o].type == t.CHART_TYPE_CHORD || n[o].type == t.CHART_TYPE_FORCE) {
                            i = n[o].type != t.CHART_TYPE_FORCE ? n[o].data : n[o].categories;
                            for (var a = 0, f = i.length; a < f; a++) if (i[a].name == e) return {
                                type: n[o].type,
                                series: n[o],
                                seriesIndex: o,
                                data: i[a],
                ...
                function L(e) {
                    ...
                    for (var f = 0, l = n.length; f < l; f++) {
                        r = n[f].name || n[f];
                        if (r === "") continue;
                        i = N(r), i.series ? (i.type == t.CHART_TYPE_PIE ? a = [i.data, i.series] : a = [i.series], u = c.getItemStyleColor(c.deepQuery(a, "itemStyle.normal.color"), i.seriesIndex, i.dataIndex, i.data), u && i.type != t.CHART_TYPE_K && O(r, u), g[r] = !0) : g[r] = !1
                    }
        ...
        }), r("echarts/component/dataRange", ["require", "./base", "zrender/tool/area", "zrender/tool/color", "zrender/tool/color", "../component"], function (e) {
            function t(t, n, r, i) {
                function T() {
                ...
                function N() {
                    var e = S, t = e.length, n, r, i, s = u.getFont(a.textStyle), c = l.x, h = l.y, p = a.itemWidth,
                        d = a.itemHeight, v = a.itemGap, m = o.getTextHeight("鍥�", s), g;
                ...
                function M() {
                    var e = S, t = e.length, n = a.itemGap, i = a.itemWidth, s = a.itemHeight, f = 0, l = 0,
                        c = u.getFont(a.textStyle), h = o.getTextHeight("鍥�", c);
                ...
                function q(e) {
                    h.position = [h.style.x - h.style._x, h.style.y - h.style._y], a.precision === 0 ? h.style.text = Math.round(w * g.start + a.min) + "" : h.style.text = (w * g.start + a.min).toFixed(a.precision), h.style.color = X(w * g.start + a.min), r.modShape(h.id, h), d.position = [d.style.x - d.style._x, d.style.y - d.style._y], a.precision === 0 ? d.style.text = Math.round(w * g.end + a.min) + "" : d.style.text = (w * g.end + a.min).toFixed(a.precision), d.style.color = X(w * g.end + a.min), r.modShape(d.id, d), r.modShape(p.id, p), r.modShape(v.id, v), e && r.modShape(m.id, m), r.refresh()
                }
        ...
        }), r("echarts/component/tooltip", ["require", "./base", "../util/ecData", "zrender/config", "zrender/shape", "zrender/tool/event", "zrender/tool/area", "zrender/tool/color", "zrender/tool/util", "zrender/shape/base", "../component"], function (e) {
            function t(t, n, r, i, s, o) {
                function U(e) {
                    if (!e) return "";
                    var t = [];
                ...
                function W(e, t, n) {
                    ...
                    e + i > j && (e = j - i), t + r > B && (t = B - r), t < 20 && (t = 0), N.style.cssText = C + k + (n ? n : "") + "left:" + e + "px;top:" + t + "px;", (j - e < 100 || B - t < 100) && setTimeout(X, 20)
                }

                function X() {
                    if (N) {
                        var e = "", t = N.offsetHeight, n = N.offsetWidth;
                        N.offsetLeft + n > j && (e += "left:" + (j - n) + "px;"), N.offsetTop + t > B && (e += "top:" + (B - t) + "px;"), e !== "" && (N.style.cssText += e)
                    }
                }
                ...
                function et(e) {
                    ...
                    if (!r) D = !1, P = e.event, P._target = P.target || P.toElement, P.zrenderX = s, P.zrenderY = o, L && w && h.isInside(m, w.getArea(), s, o) ? (!P.connectTrigger && n.dispatch(t.EVENT.TOOLTIP_IN_GRID, P), M = setTimeout(V, _)) : L && x && x.isInside([s, o]) != -1 ? M = setTimeout(V, _) : (!P.connectTrigger && n.dispatch(t.EVENT.TOOLTIP_OUT_GRID, P), A = setTimeout(z, O)); else {
                ...
                function nt(e, t) {
                    if (!N) return;
                    e == H && (N.innerHTML = t);
                    var n = "", r = N.offsetHeight, i = N.offsetWidth;
                    N.offsetLeft + i > j && (n += "left:" + (j - i) + "px;"), N.offsetTop + r > B && (n += "top:" + (B - r) + "px;"), n !== "" && (N.style.cssText += n), (j - N.offsetLeft < 100 || B - N.offsetTop < 100) && setTimeout(X, 20)
                }
                ...
                var u = e("./base");
                u.call(this, t, r);
                var a = e("../util/ecData"), f = e("zrender/config"), l = e("zrender/shape"),
                    c = e("zrender/tool/event"), h = e("zrender/tool/area"), p = e("zrender/tool/color"),
                    d = e("zrender/tool/util"), v = e("zrender/shape/base"), m = l.get("rectangle"), g = this;
                g.type = t.COMPONENT_TYPE_TOOLTIP;
                var y = g.getZlevelBase(), b = {}, w, E, S, x, T = {}, N = document.createElement("div"),
                    C = "position:absolute;display:block;border-style:solid;white-space:nowrap;", k, L, A, O, M, _, D,
                    P, H, B = r.getHeight(), j = r.getWidth(), F = !1, I = 0, q = {
                        shape: "line",
        ...
        }), r("echarts/component/toolbox", ["require", "./base", "zrender/config", "zrender/tool/util", "zrender/tool/event", "../component", "../component"], function (e) {
            function t(t, n, r, i, s) {
                function H() {
                    g = [];
                    ...
                    for (var n in e) if (e[n].show) switch (n) {
                        ...
                        case"dataZoom":
                            ...
                            break;
                        case"saveAsImage":
                            G_vmlCanvasManager || t.push({key: n, name: "saveAsImage"});
                            break;
                        default:
                            t.push({key: n, name: n})
                    }
                    if (t.length > 0) {
                        var o, n;
                        for (var i = 0, s = t.length; i < s; i++) o = t[i].name, n = t[i].key, g.push(o), w[o] = e[n].title[o] || e[n].title, e[n].icon && (E[o] = e[n].icon[o] || e[n].icon), e[n].color && (S[o] = e[n].color[o] || e[n].color);
                        b = F(), j(), B();
                        for (var i = 0, s = h.shapeList.length; i < s; i++) h.shapeList[i].id = r.newShapeId(h.type), r.addShape(h.shapeList[i]);
                        y.mark && (Q(y.markUndo), Q(y.markClear)), y.dataZoomReset && M.length === 0 && Q(y.dataZoomReset)
                    }
                }

                function B() {
                    var s = l.toolbox, o = g.length, u = b.x, a = b.y, f = s.itemSize, c = s.itemGap, v,
                        m = s.color instanceof Array ? s.color : [s.color], T = h.getFont(s.textStyle), N, C, k;
                    s.orient == "horizontal" ? (N = b.y / r.getHeight() < .5 ? "bottom" : "top", C = b.x / r.getWidth() < .5 ? "left" : "right", k = b.y / r.getHeight() < .5 ? "top" : "bottom") : N = b.x / r.getWidth() < .5 ? "right" : "left", y = {};
                    for (var L = 0; L < o; L++) {
                        v = {
                            shape: "icon",
                            zlevel: p,
                            style: {
                                ...
                                iconType: g[L],
                                lineWidth: 1,
                                strokeColor: S[g[L]] || m[L % m.length],
                                brushType: "stroke"
                            },
                            highlightStyle: {
                                lineWidth: 2,
                                text: s.showTitle ? w[g[L]] : !1,
                                textFont: T,
                                textPosition: N,
                                strokeColor: S[g[L]] || m[L % m.length]
                            },
                            hoverable: !0,
                            clickable: !0
                        }, E[g[L]] && (v.style.image = E[g[L]].replace(new RegExp("^image:\\/\\/"), ""), v.style.opacity = .8, v.highlightStyle.opacity = 1, v.shape = "image"), s.orient == "horizontal" && (L === 0 && C == "left" && (v.highlightStyle.textPosition = "specific", v.highlightStyle.textAlign = C, v.highlightStyle.textBaseline = k, v.highlightStyle.textX = u, v.highlightStyle.textY = k == "top" ? a + f + 10 : a - 10), L == o - 1 && C == "right" && (v.highlightStyle.textPosition = "specific", v.highlightStyle.textAlign = C, v.highlightStyle.textBaseline = k, v.highlightStyle.textX = u + f, v.highlightStyle.textY = k == "top" ? a + f + 10 : a - 10));
                        switch (g[L]) {
                            case"mark":
                                v.onclick = I;
                                break;
                            ...
                            case"saveAsImage":
                                ...
                                break;
                            default:
                                g[L].match("Chart") ? (v._name = g[L].replace("Chart", ""), d[v._name] && (v.style.strokeColor = x), v.onclick = tt) : v.onclick = rt
                        }
                        h.shapeList.push(v), y[g[L]] = v, s.orient == "horizontal" ? u += f + c : a += f + c
                    }
                }
                ...
                function F() {
                    var e = l.toolbox, t = g.length, n = e.itemGap, i = e.itemSize, s = 0, o = 0;
                ...
                function I(e) {
                    var t = e.target;
                    return C || N ? (J(), r.refresh()) : (K(), r.modShape(t.id, {style: {strokeColor: x}}), r.refresh(), N = !0, setTimeout(function () {
                        r && r.on(u.EVENT.CLICK, W) && r.on(u.EVENT.MOUSEMOVE, R)
                    }, 10)), !0
                }

                function q(e) {
                    var t = e.target;
                    return A || L ? (K(), r.refresh(), i.style.cursor = "default") : (J(), r.modShape(t.id, {style: {strokeColor: x}}), r.refresh(), L = !0, setTimeout(function () {
                        r && r.on(u.EVENT.MOUSEDOWN, U) && r.on(u.EVENT.MOUSEUP, z) && r.on(u.EVENT.MOUSEMOVE, R)
                    }, 10), i.style.cursor = "crosshair"), !0
                }

                function R(e) {
                    C && (k.style.xEnd = f.getX(e.event), k.style.yEnd = f.getY(e.event), r.addHoverShape(k)), A && (O.style.width = f.getX(e.event) - O.style.x, O.style.height = f.getY(e.event) - O.style.y, r.addHoverShape(O), i.style.cursor = "crosshair"), L && i.style.cursor != "pointer" && i.style.cursor != "move" && (i.style.cursor = "crosshair")
                }
                ...
                function z() {
                    if (!O || Math.abs(O.style.width) < 10 || Math.abs(O.style.height) < 10) return A = !1, !0;
                    if (A && c.dataZoom) {
                        A = !1;
                        var e = c.dataZoom.rectZoom(O.style);
                        e && (M.push({
                            start: e.start,
                            end: e.end,
                            start2: e.start2,
                            end2: e.end2
                        }), G(y.dataZoomReset), r.refresh())
                    }
                    return !0
                }

                function W(e) {
                    if (C) C = !1, h.shapeList.push(k), G(y.markUndo), G(y.markClear), r.addShape(k), r.refresh(); else if (N) {
                        C = !0;
                ...
                function X() {
                    if (C) C = !1; else {
                        ...
                        g.length == e - 1 && (Q(y.markUndo), Q(y.markClear));
                        if (g.length < e) {
                ...
                function V() {
                    C && (C = !1);
                    var e = h.shapeList.length - g.length - 1, t = !1;
                    while (e--) r.delShape(h.shapeList.pop().id), t = !0;
                    return t && (Q(y.markUndo), Q(y.markClear), r.refresh()), !0
                }

                function $() {
                    return A && (A = !1), M.pop(), M.length > 0 ? c.dataZoom.absoluteZoom(M[M.length - 1]) : (c.dataZoom.rectZoom(), Q(y.dataZoomReset), r.refresh()), !0
                }

                function J() {
                    C = !1, N && (N = !1, y.mark && r.modShape(y.mark.id, {style: {strokeColor: y.mark.highlightStyle.strokeColor}}), r.un(u.EVENT.CLICK, W), r.un(u.EVENT.MOUSEMOVE, R))
                }

                function K() {
                    A = !1, L && (L = !1, y.dataZoom && r.modShape(y.dataZoom.id, {style: {strokeColor: y.dataZoom.highlightStyle.strokeColor}}), r.un(u.EVENT.MOUSEDOWN, U), r.un(u.EVENT.MOUSEUP, z), r.un(u.EVENT.MOUSEMOVE, R))
                }
                ...
                function Z() {
                    return J(), K(), n.dispatch(t.EVENT.RESTORE), !0
                }
                ...
                function et() {
                    ...
                    o.href = n, o.setAttribute("download", (e.name ? e.name : l.title && (l.title.text || l.title.subtext) ? l.title.text || l.title.subtext : "ECharts") + "." + t), o.innerHTML = '<img src="' + n + '" title="' + (!window.attachEvent || navigator.userAgent.indexOf("Opera") !== -1 ? e.lang ? e.lang[0] : "鐐瑰嚮淇濆瓨" : "鍙抽敭->鍥剧墖鍙﹀瓨涓�") + '"/>', i.appendChild(o), document.body.appendChild(i), o = null, i = null, setTimeout(function () {
                ...
                function tt(e) {
                    ...
                    return d[r] ? d[r] = !1 : (d[r] = !0, r == t.CHART_TYPE_LINE ? d[t.CHART_TYPE_BAR] = !1 : r == t.CHART_TYPE_BAR && (d[t.CHART_TYPE_LINE] = !1), r == D ? d[P] = !1 : r == P && (d[D] = !1)), n.dispatch(t.EVENT.MAGIC_TYPE_CHANGED, e.event, {magicType: d}), !0
                }

                function nt(e) {
                    J(), d = e, !m && n.dispatch(t.EVENT.MAGIC_TYPE_CHANGED, null, {magicType: d})
                }
                ...
                function it(e) {
                    if (e.toolbox && e.toolbox.show && e.toolbox.feature.magicType && e.toolbox.feature.magicType.show && e.toolbox.feature.magicType.type && e.toolbox.feature.magicType.type.length > 0) {
                        ...
                        while (n--) {
                            r = e.series[n].type;
                            if (v[r]) {
                                s = e.xAxis instanceof Array ? e.xAxis[e.series[n].xAxisIndex || 0] : e.xAxis;
                                if (s && s.type || !0) s.__boundaryGap = typeof s.boundaryGap != "undefined" ? s.boundaryGap : !0;
                                s = e.yAxis instanceof Array ? e.yAxis[e.series[n].yAxisIndex || 0] : e.yAxis, s && s.type == "category" && (s.__boundaryGap = typeof s.boundaryGap != "undefined" ? s.boundaryGap : !0), e.series[n].__type = r, e.series[n].__itemStyle = e.series[n].itemStyle ? a.clone(e.series[n].itemStyle) : {}
                            }
                            if (v[D] || v[P]) e.series[n].__stack = e.series[n].stack
                        }
                    }
                    d = {};
                    var o = e.dataZoom;
                    if (o && o.show) {
                        var u = typeof o.start != "undefined" && o.start >= 0 && o.start <= 100 ? o.start : 0,
                            f = typeof o.end != "undefined" && o.end >= 0 && o.end <= 100 ? o.end : 100;
                        u > f && (u += f, f = u - f, u -= f), M = [{start: u, end: f, start2: 0, end2: 100}]
                    } else M = []
                }

                function st() {
                    for (var e in d) if (d[e]) return !0;
                    return !1
                }

                function ot() {
                    var e;
                    if (d[t.CHART_TYPE_LINE] || d[t.CHART_TYPE_BAR]) {
                        var n = d[t.CHART_TYPE_LINE] ? !1 : !0;
                        for (var r = 0, i = l.series.length; r < i; r++) if (v[l.series[r].type]) {
                            l.series[r].type = d[t.CHART_TYPE_LINE] ? t.CHART_TYPE_LINE : t.CHART_TYPE_BAR, l.series[r].itemStyle = a.clone(l.series[r].__itemStyle), e = l.xAxis instanceof Array ? l.xAxis[l.series[r].xAxisIndex || 0] : l.xAxis;
                            if (e && e.type || !0) e.boundaryGap = n ? !0 : e.__boundaryGap;
                            e = l.yAxis instanceof Array ? l.yAxis[l.series[r].yAxisIndex || 0] : l.yAxis, e && e.type == "category" && (e.boundaryGap = n ? !0 : e.__boundaryGap)
                        }
                    } else for (var r = 0, i = l.series.length; r < i; r++) if (v[l.series[r].type]) {
                        l.series[r].type = l.series[r].__type, l.series[r].itemStyle = l.series[r].__itemStyle, e = l.xAxis instanceof Array ? l.xAxis[l.series[r].xAxisIndex || 0] : l.xAxis;
                        if (e && e.type || !0) e.boundaryGap = e.__boundaryGap;
                        e = l.yAxis instanceof Array ? l.yAxis[l.series[r].yAxisIndex || 0] : l.yAxis, e && e.type == "category" && (e.boundaryGap = e.__boundaryGap)
                    }
                    if (d[D] || d[P]) for (var r = 0, i = l.series.length; r < i; r++) d[D] ? l.series[r].stack = "_ECHARTS_STACK_KENER_2014_" : d[P] && (l.series[r].stack = null); else for (var r = 0, i = l.series.length; r < i; r++) l.series[r].stack = l.series[r].__stack;
                    return l
                }
                ...
                function at(e, t) {
                    J(), K(), e.toolbox = h.reformOption(e.toolbox), e.toolbox.padding = h.reformCssArray(e.toolbox.padding), l = e, c = t, h.shapeList = [], e.toolbox.show && H(), lt()
                }

                function ft() {
                    J(), h.clear(), l && l.toolbox && l.toolbox.show && H(), _ && _.resize()
                }
                ...
                function ct() {
                    _ && (_.dispose(), _ = null), h.clear(), h.shapeList = null, h = null
                }
                ...
                var p = h.getZlevelBase(), d = {}, v, m = !1, g, y = {}, b, w = {}, E = {}, S = {}, x = "red",
                    T = "#ccc", N, C, k, L, A, O, M, _, D = "stack", P = "tiled";
                h.dispose = ct, h.render = at, h.resize = ft, h.hideDataView = lt, h.getMagicOption = ot, h.silence = ut, h.setMagicType = nt, h.reset = it, h.refresh = ht
            }

            return e("../component").define("toolbox", t), t
        }), r("echarts/component/dataView", ["require", "./base", "../component"], function (e) {
            function t(t, n, r, i, s) {
                function b() {
                    v = "width:" + y + "px;" + "height:" + 0 + "px;" + "background-color:#f0ffff;", f.style.cssText = d + v, s.onselectstart = function () {
                        return !1
                    }
                }
                ...
                function w(e) {
                    ...
                    i = e, f.innerHTML = '<p style="padding:8px 0;margin:0 0 10px 0;border-bottom:1px solid #eee">' + (t[0] || a[0]) + "</p>", l.style.cssText = "display:block;margin:0 0 8px 0;padding:4px 6px;overflow:auto;width:" + (y - 15) + "px;" + "height:" + (g - 100) + "px;";
                    var n = u.query(i, "toolbox.feature.dataView.optionToContent");
                    typeof n != "function" ? l.value = E() : l.value = n(i), f.appendChild(l), h.style.cssText = "float:right;padding:1px 6px;", h.innerHTML = t[1] || a[1], h.onclick = b, f.appendChild(h), u.query(i, "toolbox.feature.dataView.readOnly") === !1 ? (c.style.cssText = "float:right;margin-right:10px;padding:1px 6px;", c.innerHTML = t[2] || a[2], c.onclick = S, f.appendChild(c), l.readOnly = !1, l.style.cursor = "default") : (l.readOnly = !0, l.style.cursor = "text"), v = "width:" + y + "px;" + "height:" + g + "px;" + "background-color:#fff;", f.style.cssText = d + v, s.onselectstart = function () {
                        return !0
                    }
                }
                ...
                function S() {
                    var e = l.value, r = u.query(i, "toolbox.feature.dataView.contentToOption");
                    if (typeof r != "function") {
                        e = e.split("\n");
                        var s = [];
                        for (var o = 0, a = e.length; o < a; o++) e[o] = T(e[o]), e[o] !== "" && s.push(e[o]);
                        x(s)
                    } else r(e, i);
                ...
                function x(e) {
                    ...
                    if (i.xAxis) {
                        ...
                        for (n = 0, o = a.length; n < o; n++) if ((a[n].type || "category") == "category") {
                            l = e[f].split(",");
                            for (r = 0, s = a[n].data.length; r < s; r++) c = T(l[r] || ""), u = a[n].data[r], typeof a[n].data[r].value != "undefined" ? a[n].data[r].value = c : a[n].data[r] = c;
                            f++
                        }
                    }
                    if (i.yAxis) {
                    ...
                    for (n = 0, o = h.length; n < o; n++) {
                        ...
                        if (h[n].type == t.CHART_TYPE_SCATTER) for (var r = 0, s = h[n].data.length; r < s; r++) l = e[f], c = l.replace(" ", "").split(","), typeof h[n].data[r].value != "undefined" ? h[n].data[r].value = c : h[n].data[r] = c, f++; else {
                            l = e[f].split(",");
                            for (var r = 0, s = h[n].data.length; r < s; r++) c = (l[r] || "").replace(/.*:/, ""), c = T(c), c = c != "-" && c !== "" ? c - 0 : "-", typeof h[n].data[r].value != "undefined" ? h[n].data[r].value = c : h[n].data[r] = c;
                            f++
                        }
                    }
                }
                ...
                function C() {
                    f.className = m, b(), s.firstChild.appendChild(f), window.addEventListener ? (f.addEventListener("click", N), f.addEventListener("mousewheel", N), f.addEventListener("mousemove", N), f.addEventListener("mousedown", N), f.addEventListener("mouseup", N), f.addEventListener("touchstart", N), f.addEventListener("touchmove", N), f.addEventListener("touchend", N)) : (f.attachEvent("onclick", N), f.attachEvent("onmousewheel", N), f.attachEvent("onmousemove", N), f.attachEvent("onmousedown", N), f.attachEvent("onmouseup", N))
                }

                function k() {
                    g = r.getHeight(), y = r.getWidth(), f.offsetHeight > 10 && (v = "width:" + y + "px;" + "height:" + g + "px;" + "background-color:#fff;", f.style.cssText = d + v, l.style.cssText = "display:block;margin:0 0 8px 0;padding:4px 6px;overflow:auto;width:" + (y - 15) + "px;" + "height:" + (g - 100) + "px;")
                }
                ...
                var a = ["Data View", "close", "refresh"], f = document.createElement("div"),
                    ...
                    v, m = "echarts-dataview", g = r.getHeight(), y = r.getWidth();
        ...
        }), r("echarts/component/polar", ["require", "./base", "../util/coordinates", "zrender/tool/util", "../component"], function (e) {
            function t(t, n, r, i, s) {
                function p(e, t) {
                    s = t, B(e)
                }
                ...
                function y(e) {
                    var t = l[e], n = t.__ecIndicator, r, s = f.deepQuery(h, "indicator"), o = N(e), u, a, c, p, d = 0,
                        v = 0, m, g;
            ...
            function u(t) {
                ...
                function x(e) {
                    e.__echarts_id__ = e.__echarts_id__ || a.id;
                    var t = !0;
                    e.__echarts_id__ != a.id && (t = !1), S || (S = e.type);
                    switch (e.type) {
                ...
                function R(e) {
                    if (e.dataZoom && e.dataZoom.show || e.toolbox && e.toolbox.show && e.toolbox.feature && e.toolbox.feature.dataZoom) for (var t = 0, n = p.length; t < n; t++) if (p[t].type == i.COMPONENT_TYPE_DATAZOOM) {
                        p[t].syncBackupData(e, c);
                        return
                    }
                    var r = e.series, s;
                    for (var t = 0, n = r.length; t < n; t++) {
                        s = r[t].data;
                        for (var o = 0, u = s.length; o < u; o++) c.series[t].data[o] = s[o]
                    }
                }
                ...
                function z(n) {
                    ...
                    y.render(n), b.render(n, {dataZoom: T}), f.render();
                ...
                function X(t) {
                    ...
                    if (!w && t.option) {
                        ...
                        c.toolbox && c.toolbox.show && c.toolbox.feature.magicType && c.toolbox.feature.magicType.length > 0 ? n = q() : n = q(y.getOption()), r.merge(n, t.option, {
                            overwrite: !0,
                            recursive: !0
                        }), r.merge(c, t.option, {overwrite: !0, recursive: !0}), r.merge(h, t.option, {
                            overwrite: !0,
                            recursive: !0
                        }), y.refresh(n), b.refresh(n)
                    }
                    f.clearAnimation();
                    for (var i = 0, s = p.length; i < s; i++) p[i].refresh && p[i].refresh(n);
                    f.refresh()
                }
                ...
                function K() {
                    var t = e("zrender/tool/util");
                    return c.toolbox && c.toolbox.show && c.toolbox.feature.magicType && c.toolbox.feature.magicType.length > 0 ? t.clone(q()) : t.clone(q(y.getOption()))
                }
                ...
                function Y(t, n, r, s, o) {
                    var u = e("zrender/tool/util"), f = t instanceof Array ? t : [[t, n, r, s, o]], l, v, m;
                    c.toolbox && c.toolbox.show && c.toolbox.feature.magicType && c.toolbox.feature.magicType.length > 0 ? m = q() : m = q(y.getOption());
                    for (var w = 0, E = f.length; w < E; w++) {
                        t = f[w][0], n = f[w][1], r = f[w][2], s = f[w][3], o = f[w][4];
                        if (h.series[t]) {
                            ...
                            if (typeof o != "undefined" && h.series[t].type == i.CHART_TYPE_PIE && c.legend && c.legend.data) m.legend.data = c.legend.data, r ? (h.legend.data.unshift(o), c.legend.data.unshift(o)) : (h.legend.data.push(o), c.legend.data.push(o)), s || (v = u.indexOf(c.legend.data, n.name), v != -1 && (h.legend.data.splice(v, 1), c.legend.data.splice(v, 1))), g[o] = !0; else if (typeof o != "undefined" && typeof h.xAxis != "undefined" && typeof h.yAxis != "undefined") {
                                l = h.series[t].xAxisIndex || 0;
                                if (typeof h.xAxis[l].type == "undefined" || h.xAxis[l].type == "category") r ? (h.xAxis[l].data.unshift(o), c.xAxis[l].data.unshift(o), s || (h.xAxis[l].data.pop(), c.xAxis[l].data.pop())) : (h.xAxis[l].data.push(o), c.xAxis[l].data.push(o), s || (h.xAxis[l].data.shift(), c.xAxis[l].data.shift()));
                                l = h.series[t].yAxisIndex || 0, h.yAxis[l].type == "category" && (r ? (h.yAxis[l].data.unshift(o), c.yAxis[l].data.unshift(o), s || (h.yAxis[l].data.pop(), c.yAxis[l].data.pop())) : (h.yAxis[l].data.push(o), c.yAxis[l].data.push(o), s || (h.yAxis[l].data.shift(), c.yAxis[l].data.shift())))
                            }
                        }
                    }
                    m.legend && (m.legend.selected = g);
                    for (var w = 0, E = p.length; w < E; w++) m.addDataAnimation && p[w].addDataAnimation && p[w].addDataAnimation(f), p[w].type == i.COMPONENT_TYPE_DATAZOOM && (p[w].silence(!0), p[w].init(m), p[w].silence(!1));
                    return y.refresh(m), b.refresh(m), setTimeout(function () {
                        d.dispatch(i.EVENT.REFRESH, "", {option: m})
                    }, m.addDataAnimation ? 500 : 0), a
                }
                ...
                function rt(n) {
                    if (!lt()) return tt(n);
                    var r, i = i = [t.offsetLeft, t.offsetTop, t.offsetWidth, t.offsetHeight], s = {
                        self: {
                            img: a.getDataURL(n),
                            left: i[0],
                            top: i[1],
                    ...
                    for (var h in s) d.addShape({
                        shape: "image",
                        style: {x: s[h].left - o, y: s[h].top - u, image: s[h].img}
                    });
                    d.render();
                ...
                function at(e) {
                    ...
                    for (var r in v) return a;
                    return v = !1, a
                }

                function ft(e) {
                    e.__echarts_id__ != a.id && x(e)
                }
            ...
            var t = {}, n = t, r = !!document.createElement("canvas").getContext, i = new Date - 0, s = {},
                o = "_echarts_instance_";
            return t.version = "1.3.8", t.dependencies = {zrender: "1.1.0"}, t.init = function (e, t) {
        ...
        }), r("echarts/chart/scatter", ["require", "../component/base", "./calculableBase", "zrender/tool/color", "../util/shape/symbol", "../chart"], function (e) {
            function t(t, n, r, i, s) {
                function v() {
                    f.selectedMap = {};
                ...
                function g(e) {
                    ...
                    for (var s in e) {
                        ...
                        if (t.large && t.data.length > t.largeThreshold) {
                            f.shapeList.push(b(n, f.getItemStyleColor(f.query(t, "itemStyle.normal.color"), s, -1) || h[s]));
                            continue
                        }
                        for (var o = 0, u = n.length; o < u; o++) r = n[o], i = y(s, r[2], r[3], r[0], r[1]), i && f.shapeList.push(i)
                    }
                }
                ...
                f.getMarkCoord = w, f.animation = T, f.init = E, f.refresh = S, f.ondataRange = x, E(i, s)
            }
        ...
        }), r("echarts/chart/k", ["require", "../component/base", "./calculableBase", "../util/ecData", "../util/shape/candle", "../chart"], function (e) {
            function t(t, n, r, i, s) {
                function h() {
                    f.selectedMap = {};
                    var e = {top: [], bottom: []}, n;
        ...
        }), r("echarts/chart/radar", ["require", "../component/base", "./calculableBase", "../util/ecData", "zrender/tool/color", "../util/accMath", "../chart"], function (e) {
            function t(t, n, r, i, s) {
                function y() {
                    var e = s.legend;
                    l.selectedMap = {}, v = [], g = 0;
                ...
                function N(t, n) {
                    ...
                    var r = t.target, o = t.dragged, u = a.get(r, "seriesIndex"), f = a.get(r, "dataIndex"), h,
                        p = s.legend, d;
                    if (f == -1) h = {
                        value: a.get(o, "value"),
                        name: a.get(o, "name")
                ...
                function L() {
                    var e = l.query(i, "animationDuration"), t = l.query(i, "animationEasing"), n, o, u, f, h,
                        p = s.polar, d, v, m, g;
        ...
        }), r("echarts/chart/chord", ["require", "../util/shape/chord", "../component/base", "./calculableBase", "../util/ecData", "zrender/tool/util", "zrender/tool/vector", "../util/ndarray", "../chart"], function (e) {
            function n(n, r, i, s, o) {
                ...
                f.call(this, i, s);
                var l = e("../util/ecData"), c = e("zrender/tool/util"), h = e("zrender/tool/vector"),
                    p = e("../util/ndarray"), d, v, m, g;
                this.type = n.CHART_TYPE_CHORD;
                var y = u.getZlevelBase(), b, w = [], E, S, x, T, N, C, k, L, A, O, M, _ = 0, D, P = [], H = [], B = 4,
                    j = 4;
        ...
        }), r("echarts/chart/force", ["require", "../component/base", "./calculableBase", "../util/ecData", "zrender/config", "zrender/tool/event", "zrender/tool/util", "zrender/tool/vector", "../util/ndarray", "../chart"], function (e) {
            function r(r, o, u, a, f) {
                ...
                c.call(this, u, a);
                var h = e("../util/ecData"), p = e("zrender/config"), d = e("zrender/tool/event"),
                    v = e("zrender/tool/util"), m = e("zrender/tool/vector"), g = e("../util/ndarray"), y, b = this;
                b.type = r.CHART_TYPE_FORCE;
                var w, E, S = [], x = [], T = [], N, C, k, L, A, O, M = [], _ = [], D = [], P = [], H = [], B = [],
                    j = [], F = [], I, q, R, U, z, W, X, V = 1 / 60, $, J, K = [], Q, G, st;
        ...
        }), r("echarts/chart/line", ["require", "../component/base", "./calculableBase", "zrender/tool/color", "zrender/shape", "zrender/shape", "../util/shape/halfSmoothPolygon", "../chart"], function (e) {
            function t(t, r, i, s, o) {
                function g() {
                    p = {}, l.selectedMap = {};
                ...
                function y(e, t) {
                    ...
                    for (var s = 0, u = t.length; s < u; s++) l.buildMark(c[t[s]], t[s], o)
                }
                ...
                function w(e, t) {
                    var n = t[0][0], r = c[n], i = r.xAxisIndex, u = o.xAxis.getAxis(i), a, f, h, d, v, m, g, y, b = {},
                        w, E;
                    for (var x = 0, N = e; x < N; x++) {
                        if (typeof u.getNameByIndex(x) == "undefined") break;
                        h = u.getCoordByIndex(x);
                        for (var C = 0, k = t.length; C < k; C++) {
                            a = c[t[C][0]].yAxisIndex || 0, f = o.yAxis.getAxis(a), m = v = y = g = f.getCoord(0);
                            for (var L = 0, A = t[C].length; L < A; L++) {
                                n = t[C][L], r = c[n], w = r.data[x], E = typeof w != "undefined" ? typeof w.value != "undefined" ? w.value : w : "-", b[n] = b[n] || [];
                                if (E == "-") {
                                    b[n].length > 0 && (p[n] = p[n] || [], p[n].push(b[n]), b[n] = []);
                                    continue
                                }
                                d = f.getCoord(E), E >= 0 ? (v -= m - d, d = v) : E < 0 && (g += d - y, d = g), b[n].push([h, d, x, u.getNameByIndex(x), h, m])
                            }
                        }
                        v = o.grid.getY();
                        var O;
                        for (var C = 0, k = t.length; C < k; C++) for (var L = 0, A = t[C].length; L < A; L++) {
                            n = t[C][L], r = c[n], w = r.data[x], E = typeof w != "undefined" ? typeof w.value != "undefined" ? w.value : w : "-";
                            if (E != "-") continue;
                            l.deepQuery([w, r, s], "calculable") && (O = l.deepQuery([w, r], "symbolSize"), v += O * 2 + 5, d = v, l.shapeList.push(T(n, x, u.getNameByIndex(x), h, d, "horizontal")))
                        }
                    }
                    for (var M in b) b[M].length > 0 && (p[M] = p[M] || [], p[M].push(b[M]), b[M] = []);
                    S(p, u, "horizontal")
                }

                function E(e, t) {
                    var n = t[0][0], r = c[n], i = r.yAxisIndex, u = o.yAxis.getAxis(i), a, f, h, d, v, m, g, y, b = {},
                        w, E;
                    for (var x = 0, N = e; x < N; x++) {
                        if (typeof u.getNameByIndex(x) == "undefined") break;
                        d = u.getCoordByIndex(x);
                        for (var C = 0, k = t.length; C < k; C++) {
                            a = c[t[C][0]].xAxisIndex || 0, f = o.xAxis.getAxis(a), m = v = y = g = f.getCoord(0);
                            for (var L = 0, A = t[C].length; L < A; L++) {
                                n = t[C][L], r = c[n], w = r.data[x], E = typeof w != "undefined" ? typeof w.value != "undefined" ? w.value : w : "-", b[n] = b[n] || [];
                                if (E == "-") {
                                    b[n].length > 0 && (p[n] = p[n] || [], p[n].push(b[n]), b[n] = []);
                                ...
                                h = f.getCoord(E), E >= 0 ? (v += h - m, h = v) : E < 0 && (g -= y - h, h = g), b[n].push([h, d, x, u.getNameByIndex(x), m, d])
                            }
                        }
                        v = o.grid.getXend();
                        var O;
                        for (var C = 0, k = t.length; C < k; C++) for (var L = 0, A = t[C].length; L < A; L++) {
                            n = t[C][L], r = c[n], w = r.data[x], E = typeof w != "undefined" ? typeof w.value != "undefined" ? w.value : w : "-";
                            if (E != "-") continue;
                            l.deepQuery([w, r, s], "calculable") && (O = l.deepQuery([w, r], "symbolSize"), v -= O * 2 + 5, h = v, l.shapeList.push(T(n, x, u.getNameByIndex(x), h, d, "vertical")))
                        }
                    }
                    for (var M in b) b[M].length > 0 && (p[M] = p[M] || [], p[M].push(b[M]), b[M] = []);
                    S(p, u, "vertical")
                ...
                function C(e, t, n) {
                    var r = o.xAxis.getAxis(e.xAxisIndex), i = o.yAxis.getAxis(e.yAxisIndex);
                    return [typeof n.xAxis != "string" && r.getCoordByIndex ? r.getCoordByIndex(n.xAxis || 0) : r.getCoord(n.xAxis || 0), typeof n.yAxis != "string" && i.getCoordByIndex ? i.getCoordByIndex(n.yAxis || 0) : i.getCoord(n.yAxis || 0)]
                }
        ...
        }), r("echarts/chart/bar", ["require", "../component/base", "./calculableBase", "../util/ecData", "zrender/tool/color", "../chart"], function (e) {
            function t(t, n, r, i, s) {
                function d() {
                    l.selectedMap = {};
                ...
                function g(e, n, r) {
                    var o = n[0][0], u = c[o], a = u.xAxisIndex, f = s.xAxis.getAxis(a), h, p, d = b(f, n), v = d.gap,
                        m = d.barGap, g = d.barWidthMap, y = d.barWidth, S = d.barMinHeightMap, x, T = {}, N, C, k, L,
                        A, O, M, _, D;
                    for (var P = 0, H = e; P < H; P++) {
                        ...
                        for (var B = 0, j = n.length; B < j; B++) {
                            ...
                            for (var F = 0, I = n[B].length; F < I; F++) {
                                ...
                                if (D == "-") continue;
                                C = p.getCoord(D), D > 0 ? (x = L - C, I == 1 && S[o] > x && (x = S[o]), k -= x, C = k) : D < 0 ? (x = C - O, I == 1 && S[o] > x && (x = S[o]), C = A, A += x) : (x = L - C, k -= x, C = k), M = w(o, P, f.getNameByIndex(P), N, C, g[o] || y, x, "vertical"), T[o] = T[o] || {}, T[o][P] = N + (g[o] || y) / 2, l.shapeList.push(M)
                            }
                            for (var F = 0, I = n[B].length; F < I; F++) {
                                o = n[B][F], u = c[o], _ = u.data[P], D = typeof _ != "undefined" ? typeof _.value != "undefined" ? _.value : _ : "-";
                                if (D != "-") continue;
                    ...
                    for (var P = 0, H = e; P < H; P++) {
                        ...
                        for (var B = 0, j = n.length; B < j; B++) {
                            ...
                            for (var F = 0, I = n[B].length; F < I; F++) {
                                o = n[B][F], u = c[o], _ = u.data[P], D = typeof _ != "undefined" ? typeof _.value != "undefined" ? _.value : _ : "-";
                                if (D == "-") continue;
                                N = p.getCoord(D), D > 0 ? (x = N - L, I == 1 && S[o] > x && (x = S[o]), N = k, k += x) : D < 0 ? (x = O - N, I == 1 && S[o] > x && (x = S[o]), A -= x, N = A) : (x = N - L, N = k, k += x), M = w(o, P, f.getNameByIndex(P), N, C - (g[o] || y), x, g[o] || y, "horizontal"), T[o] = T[o] || {}, T[o][P] = C - (g[o] || y) / 2, l.shapeList.push(M)
                            }
                            for (var F = 0, I = n[B].length; F < I; F++) {
                                o = n[B][F], u = c[o], _ = u.data[P], D = typeof _ != "undefined" ? typeof _.value != "undefined" ? _.value : _ : "-";
                                if (D != "-") continue;
                ...
                function w(e, t, n, r, s, o, u, d) {
                    var v, m = c[e], g = m.data[t], y = p[e], b = [g, m],
                ...
                function S(e, t, n, r) {
                    ...
                    return r.isHorizontal ? (u = typeof n.xAxis == "string" && i.getIndexByName ? i.getIndexByName(n.xAxis) : n.xAxis || 0, a = [r.xMarkMap[t][u], o.getCoord(n.yAxis || 0)]) : (u = typeof n.yAxis == "string" && o.getIndexByName ? o.getIndexByName(n.yAxis) : n.yAxis || 0, a = [i.getCoord(n.xAxis || 0), r.xMarkMap[t][u]]), a
                }
        ...
        }), r("echarts/chart/pie", ["require", "../component/base", "./calculableBase", "../util/ecData", "zrender/tool/math", "zrender/tool/util", "zrender/tool/color", "../util/accMath", "../chart"], function (e) {
            function t(t, n, r, i, s) {
                function g() {
                    var e = s.legend;
                    h.selectedMap = {}, m = {};
                    ...
                    for (var l = 0, c = p.length; l < c; l++) if (p[l].type == t.CHART_TYPE_PIE) {
                        ...
                        n = h.parseCenter(p[l].center), o = h.parseRadius(p[l].radius), v = v || p[l].selectedMode, m[l] = [], h.deepQuery([p[l], i], "calculable") && (u = {
                ...
                function y(e) {
                    ...
                    for (var c = 0, d = n.length; c < d; c++) o = n[c].name, i ? h.selectedMap[o] = i.isSelected(o) : h.selectedMap[o] = !0, h.selectedMap[o] && (+n[c].value !== 0 ? u++ : a++, f += +n[c].value, l = Math.max(l, +n[c].value));
                    ...
                    for (var c = 0, d = n.length; c < d; c++) {
                        ...
                        i ? N = i.getColor(o) : N = r.getColor(c), m = v, v = n[c].value / f, C != "area" ? E = y ? w - v * x - (v !== 0 ? S : .01) : v * x + w + (v !== 0 ? S : .01) : E = y ? w - 360 / d : 360 / d + w, E = E.toFixed(2) - 0, v = (v * 100).toFixed(2), k = h.parseRadius(t.radius), L = +k[0], A = +k[1], C == "radius" ? A = n[c].value / l * (A - L) * .8 + (A - L) * .2 + L : C == "area" && (A = Math.sqrt(n[c].value / l) * (A - L) + L);
                        if (y) {
                            var O;
                            O = w, w = E, E = O
                        }
                ...
                function w(e, t, n, r, s, o, u, a, l) {
                    var g = p[e], y = g.data[t], b = [y, g], w = h.parseCenter(g.center),
                        E = h.deepMerge(b, "itemStyle.normal") || {}, S = h.deepMerge(b, "itemStyle.emphasis") || {},
                        x = h.getItemStyleColor(E.color, e, t, y) || l,
                        C = h.getItemStyleColor(S.color, e, t, y) || (typeof x == "string" ? c.lift(x, -0.2) : x), k = {
                            shape: "sector",
                            zlevel: d,
                            clickable: !0,
                            style: {
                    ...
                    if (r) {
                        var L = ((k.style.startAngle + k.style.endAngle) / 2).toFixed(2) - 0;
                        k.style._hasSelected = !0, k.style._x = k.style.x, k.style._y = k.style.y;
                        var A = h.query(g, "selectedOffset");
                        k.style.x += f.cos(L, !0) * A, k.style.y -= f.sin(L, !0) * A, m[e][t] = !0
                    } else m[e][t] = !1;
                    v && (k.onclick = h.shapeHandler.onclick), h.deepQuery([y, g, i], "calculable") && (h.setCalculable(k), k.draggable = !0);
                    if (T(g, y, !0) || N(g, y, !0)) k.onmouseover = h.shapeHandler.onmouseover;
                    return k
                }
                ...
                function E(e, t, n, r, i, s, o, u) {
                    ...
                    var v = u ? "emphasis" : "normal",
                        ...
                        g = m[v].label, y = g.textStyle || {}, b = h.parseCenter(a.center), w = b[0], E = b[1], x, N,
                        C = ((s + i) / 2 + 360) % 360, k = h.parseRadius(a.radius), L, A = "middle";
                    return g.position == "center" ? (k = k[1], x = w, N = E, L = "center") : g.position == "inner" ? (k = (k[0] + k[1]) / 2 + r, x = Math.round(w + k * f.cos(C, !0)), N = Math.round(E - k * f.sin(C, !0)), o = "#fff", L = "center") : (k = k[1] - -m[v].labelLine.length + r, x = w + k * f.cos(C, !0), N = E - k * f.sin(C, !0), L = C >= 90 && C <= 270 ? "right" : "left"), g.position != "center" && g.position != "inner" && (x += L == "left" ? 20 : -20), c.__labelX = x - (L == "left" ? 5 : -5), c.__labelY = N, {
                        shape: "text",
                        zlevel: d + 1,
                        hoverable: !1,
                        style: {
                            ...
                            text: S(e, t, n, v),
                            textAlign: y.align || L,
                            textBaseline: y.baseline || A,
                            textFont: h.getFont(y)
                        },
                        highlightStyle: {brushType: "fill"},
                        _seriesIndex: e,
                        _dataIndex: t
                ...
                function x(e, t, n, r, i, s, o, u, a) {
                    ...
                    if (N(c, v, a)) {
                        var m = a ? "emphasis" : "normal",
                            g = l.merge(l.clone(v.itemStyle) || {}, c.itemStyle, {overwrite: !1, recursive: !0}),
                            y = g[m].labelLine, b = y.lineStyle || {}, w = h.parseCenter(c.center), E = w[0], S = w[1],
                            x = i, T = h.parseRadius(c.radius)[1] - -y.length + n, C = (o + s) / 2 % 360,
                            k = f.cos(C, !0), L = f.sin(C, !0);
                        return {
                            shape: "brokenLine",
                            zlevel: d + 1,
                            hoverable: !1,
                            style: {
                                pointList: [[E + x * k, S - x * L], [E + T * k, S - T * L], [v.__labelX, v.__labelY]],
                                strokeColor: b.color || u,
                                lineType: b.type,
                                lineWidth: b.width
                            },
                            _seriesIndex: e,
                ...
                function _(t, n) {
                    ...
                    var r = t.target, o = t.dragged, u = a.get(r, "seriesIndex"), f = a.get(r, "dataIndex"), l,
                        c = s.legend;
                    if (f == -1) l = {
                        value: a.get(o, "value"),
                        name: a.get(o, "name")
...
//define('{pro}external/chart/echarts.js',[],f)